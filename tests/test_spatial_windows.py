# from https://github.com/For-a-few-DPPs-more/structure-factor/blob/main/tests/test_spatial_windows.py
import numpy as np
import pytest
...
from mcrppy.point_processes import get_random_number_generator
